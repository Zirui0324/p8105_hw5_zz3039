...
t_test = t.test(sim_data\$x, alternative = c(“two.sided”), mu = mu) %\>%
broom::tidy()
...
```
    ...
    ##          <dbl> <dbl> <int>  <dbl>   <dbl>
    ##  1          30     1     1  1.66  0.0644 
    ##  2          30     1     2  2.05  0.0105 
    ##  3          30     1     3  0.477 0.659  
    ##  4          30     1     4  2.10  0.0711 
    ##  5          30     1     5  3.16  0.00103
    ##  6          30     1     6  1.92  0.0474 
    ##  7          30     1     7  1.30  0.205  
    ##  8          30     1     8  1.88  0.00459
    ##  9          30     1     9  2.31  0.0323 
    ## 10          30     1    10  1.25  0.229  
